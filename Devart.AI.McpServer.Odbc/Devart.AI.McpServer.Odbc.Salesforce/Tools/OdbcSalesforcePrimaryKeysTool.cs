// --------------------------------------------------------------------------
// <copyright file="OdbcSalesforcePrimaryKeysTool.cs" company="Devart">
//
...
{
  internal sealed class OdbcSalesforcePrimaryKeysTool(McpConfiguration serverConfiguration) : PrimaryKeysTool(serverConfiguration)
  {
