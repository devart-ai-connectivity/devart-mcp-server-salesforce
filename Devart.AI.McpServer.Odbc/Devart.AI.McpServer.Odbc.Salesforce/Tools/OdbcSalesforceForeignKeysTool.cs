// --------------------------------------------------------------------------
// <copyright file="OdbcSalesforceForeignKeysTool.cs" company="Devart">
//
...
namespace Devart.AI.McpServer.Odbc.Salesforce.Tools
{
  internal sealed class OdbcSalesforceForeignKeysTool(McpConfiguration serverConfiguration) : ForeignKeysTool(serverConfiguration)
  {
